...
After the frontmatter-strip fix, **1 chapters** clear the engineering 8.5 blowup line and **192 (16.8%)** sit in the 7-8.49 publish-eligible band.

## 2. Engineering score distribution (E_min = min(E1..E5))

| bucket | chapters | share | meaning |
|---|---:|---:|---|
| <5 | 526 | 45.9% | clearly needs rewrite (structural) |
| 5-6.99 | 426 | 37.2% | needs choice or action |
| 7-7.99 | 150 | 13.1% | near entry, fix one dim |
...
|---|---:|---:|---|
| publish (min>=7.0) | 193 | 0 | reader evidence missing |
