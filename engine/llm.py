    ...
    if "【按方案写正文】" in user:
        ...
        return json.dumps({
            ...
            "frontmatter": {
                ...
                "hook": "the door opens",
                "hook_evidence": body[:4],
                "causal": {
                    "pressure": "门外出现无法回避的来客",
                    "choice": f"{a}选择回头面对{b}",
                    "cost": f"{a}暴露了自己并失去继续隐藏的时间",
                    "state_change": f"{a}与{b}的关系从试探变成共同承担",
                    "next_pressure": "门外的人带来一笔必须当夜结算的旧账",
                },
                "faction_moves": [{"faction": "mock-faction", "move": "以来客施压", "consequence": "旧账进入当前场景", "stance_change": "从观察转为对抗", "evidence": body[:4]}],
                "state_updates": [{"entity": f"{a}/{b}", "change": "关系与风险同时上升", "evidence": body[:4]}],
            },
            "incarnations": incarn,
