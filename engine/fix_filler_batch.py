...
REPLACEMENTS = [
    ...
    (re.compile(r"院里安静了，"), "院里没人接，"),
    (re.compile(r"院里安静"), "院里没人接"),
    (re.compile(r"院子里安静"), "院里没人接"),
    (re.compile(r"院中安静"), "院中没人接"),
    (re.compile(r"院子。\s*\n\s*安静"), "院里没人接"),
    (re.compile(r"院子里。\s*\n\s*安静"), "院里没人接"),
    (re.compile(r"院里。\s*\n\s*安静"), "院里没人接"),
    (re.compile(r"廊下安静"), "廊下没人出声"),
    (re.compile(r"廊下，安静"), "廊下没人出声"),
    (re.compile(r"院里，安静"), "院里没人接"),
    (re.compile(r"院中，安静"), "院中没人接"),
    (re.compile(r"院子里，安静"), "院里没人接"),
    (re.compile(r"夜深了"), "入了夜"),
    (re.compile(r"夜深"), "入了夜"),
    (re.compile(r"屋里空"), "屋里没人"),
    (re.compile(r"屋里空的"), "屋里没人"),
    (re.compile(r"廊下很静"), "廊下没人出声"),
    (re.compile(r"廊里安静"), "廊里没人出声"),
    (re.compile(r"廊里很静"), "廊里没人出声"),
    (re.compile(r"门外安静"), "门外没人出声"),
    (re.compile(r"门外很静"), "门外没人出声"),
    (re.compile(r"厅里安静"), "厅里没人出声"),
    (re.compile(r"厅里很静"), "厅里没人出声"),
    (re.compile(r"屋子里安静"), "屋里没人出声"),
    ...
    (re.compile(r"屋里安静了——"), "屋里没人出声——"),
    (re.compile(r"屋里安静——"), "屋里没人出声——"),
    (re.compile(r"屋里安静了一阵"), "屋里没人接"),
    (re.compile(r"屋里安静了下来"), "屋里没人接"),
    (re.compile(r"屋里安静下来"), "屋里没人接"),
