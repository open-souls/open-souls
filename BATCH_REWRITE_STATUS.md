...
- `python engine/batch_rewrite.py --status` 最新为：607 个静态 stub 编号、0 个实际剩余 stub、220 个仅存在于 manifest 而未落盘的编号、299 个唯一 lint 错误号、0 个当前候选文件未过完整发布门。
...
- 机器扫描：1331 个章文件；337 章 ERROR，77 章 WARN。全书机器门仍未过，这只是基线观测，不等于本轮绿段的发布证明。
...
- 本轮追加 ch932 后的最新刷新值为：299 个唯一 lint 错误号、0 个当前候选文件未过完整发布门，机器扫描为 337 章 ERROR、77 章 WARN；上一条 300/1 为 ch907、ch926 提交前记录。全量 ERROR 目前只剩历史重复文件 ch881-灶边雪.md，canonical ch881-林崇看.md 已通过主编门。
