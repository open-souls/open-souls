...
- `python engine/batch_rewrite.py --status` 最新为：607 个静态 stub 编号、81 个实际剩余 stub、220 个仅存在于 manifest 而未落盘的编号、356 个唯一 lint 错误号、137 个当前候选文件未过完整发布门。
