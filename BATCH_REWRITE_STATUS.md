...
- `python engine/batch_rewrite.py --status` 最新为：607 个静态 stub 编号、0 个实际剩余 stub、220 个仅存在于 manifest 而未落盘的编号、302 个唯一 lint 错误号、3 个当前候选文件未过完整发布门。
...
- 机器扫描：1331 个章文件；340 章 ERROR，77 章 WARN。全书机器门仍未过，这只是基线观测，不等于本轮绿段的发布证明。
